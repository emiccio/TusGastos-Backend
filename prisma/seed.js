...
async function main() {
  ...
  const transactions = [
    ...
    { type: 'expense', amount: 15000, category: 'Auto', description: 'YPF', date: new Date(now.getFullYear(), now.getMonth(), 10) },
    { type: 'expense', amount: 18200, category: 'Comida', description: 'Almuerzo trabajo', date: new Date(now.getFullYear(), now.getMonth(), 12) },
    { type: 'expense', amount: 9800, category: 'Casa', description: 'Luz', date: new Date(now.getFullYear(), now.getMonth(), 14) },
